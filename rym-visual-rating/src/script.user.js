...
class VisualRatingBar {
    constructor(options) {
        ...
        this.barOptions.animation = (options === null || options === void 0 ? void 0 : options.animation) === undefined || (options === null || options === void 0 ? void 0 : options.animation);
        this.barOptions.borderRadius = (options === null || options === void 0 ? void 0 : options.borderRadius) || 6;
        this.barOptions.colors = (options === null || options === void 0 ? void 0 : options.colors) || 'vibrant';
        this.barOptions.themeMode = this.getThemeMode() || false;
        this.barOptions.height = (options === null || options === void 0 ? void 0 : options.height) || 20;
        this.barOptions.shadow = (options === null || options === void 0 ? void 0 : options.shadow) === undefined || (options === null || options === void 0 ? void 0 : options.shadow);
        this.barOptions.style = (options === null || options === void 0 ? void 0 : options.style) || 'gradual';
    }
    init() {
