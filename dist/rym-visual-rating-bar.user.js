...
class OptionsMenu {
    build() {
        ...
        if (headerNode)
            headerNode.style.filter = 'blur(3px)';
        if (pageWrapper)
            pageWrapper.style.filter = 'blur(3px)';
...
class VisualRatingBar {
    constructor(options) {
        ...
        this.getBackgroundColor = () => {
            ...
            if (!elementNode)
                throw new Error("Can't find the .release_right_column element");
        ...
        this.getThemeMode = () => {
            ...
            if (!currentThemeMode)
                return null;
            if (!['eve', 'night', 'light'].includes(currentThemeMode))
                return null;
        ...
        this.barOptions.animation = (options === null || options === void 0 ? void 0 : options.animation) == undefined ? animation : options === null || options === void 0 ? void 0 : options.animation;
        this.barOptions.borderRadius = (options === null || options === void 0 ? void 0 : options.borderRadius) || borderRadius;
        this.barOptions.colors = (options === null || options === void 0 ? void 0 : options.colors) || colors;
        this.barOptions.themeMode = this.getThemeMode() || themeMode;
        this.barOptions.height = (options === null || options === void 0 ? void 0 : options.height) || height;
        this.barOptions.shadow = (options === null || options === void 0 ? void 0 : options.shadow) == undefined ? shadow : options === null || options === void 0 ? void 0 : options.shadow;
        this.barOptions.style = (options === null || options === void 0 ? void 0 : options.style) || style;
    }
    init() {
        var _a, _b, _c;
        ...
        const ratingText = ratingNode === null || ratingNode === void 0 ? void 0 : ratingNode.textContent;
        if (!ratingText)
            throw new Error("Can't retieve the rating text of element span.avg_rating");
        ...
        if (borderRadius)
            barMask.style.borderTopRightRadius = `${borderRadius}px`;
        if (borderRadius)
            barMask.style.borderBottomRightRadius = `${borderRadius}px`;
        if (shadow)
            barMask.style.boxShadow = '#00000063 0px 0px 3px 0px inset';
        // Bar gradient
        ...
        if (borderRadius)
            barGradient.style.borderRadius = `${borderRadius}px`;
        if (themeMode !== 'light')
            barGradient.style.filter = 'saturate(50%)';
        if (shadow)
            barGradient.style.boxShadow = '#0000009c 0px 0px 4px 0px inset';
        const ratingNodeParent = (_a = ratingNode === null || ratingNode === void 0 ? void 0 : ratingNode.parentNode) === null || _a === void 0 ? void 0 : _a.parentNode;
        ratingNodeParent === null || ratingNodeParent === void 0 ? void 0 : ratingNodeParent.appendChild(barWrapper);
        ...
        (_b = document.querySelectorAll('div.header_theme_button')[1]) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            const themeMode = this.getThemeMode();
            barMask.style.backgroundColor = this.getBackgroundColor();
            barGradient.style.filter = `saturate(${themeMode === 'light' ? 100 : 50}%)`;
        });
        // Options menu
        (_c = document.getElementById('userscript-bar-wrapper')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
            alert('hello ici!!!');
        });
